...
module.exports = {
  ...
  caseStudies: { en: "/case-studies/", sv: "/sv/kundcase/" },
  caseKew: { en: "/case-studies/royal-botanic-gardens-kew/", sv: "/sv/kundcase/royal-botanic-gardens-kew/" },
  caseNationalHighways: { en: "/case-studies/national-highways/", sv: "/sv/kundcase/national-highways/" },
  caseScgPortal: { en: "/case-studies/scg-customer-portal/", sv: "/sv/kundcase/scg-kundportal/" },
  caseArgyll: { en: "/case-studies/argyll-yardi-integration/", sv: "/sv/kundcase/argyll-yardi-integration/" },
  caseHeritageDirectDebit: { en: "/case-studies/heritage-direct-debit/", sv: "/sv/kundcase/autogiro-for-besoksmal/" },
  caseLegacyAi: { en: "/case-studies/legacy-modernisation-with-ai/", sv: "/sv/kundcase/modernisering-med-ai/" },
  partners: { en: "/partners/", sv: "/sv/partner/" },
  sectorMembership: { en: "/sectors/membership-bodies-and-charities/", sv: "/sv/branscher/medlemsorganisationer/" },
  sectorHeritage: { en: "/sectors/visitor-attractions-and-heritage/", sv: "/sv/branscher/besoksmal-och-kulturarv/" },
